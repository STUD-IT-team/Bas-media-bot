...
Крайне рекомендуется предварительно настроить себе SSH ключ на GitHub.
...
и отметить в качестве ревьюверов **@Formak21** и **@impervguin**. Если ваш реквест долго висит пишите нам в Telegram.
...
Если у тебя сложности с docker, читай документацию. Если не понял пиши @Formak21 или @impervguin.